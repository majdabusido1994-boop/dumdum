    ...
    >
      ...
      <div className="relative z-10 text-center px-6">
        <div className="animate-fade-in">
          <p className="text-sm uppercase tracking-[0.4em] text-[#e8722a] text-glow-amber mb-6">
        ...
        {/* Glitch Logo */}
        <h1
          className="font-display text-[clamp(4rem,15vw,12rem)] leading-[0.85] tracking-wider animate-slide-up glitch section-heading"
          data-text="DUMDUM"
        >
        ...
        {/* Arabic accent */}
        <p className="mt-2 text-2xl text-[#f0ede8]/15 font-light tracking-widest animate-fade-in">
          دمدم
        </p>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up">
          <a
            href="#events"
            className="btn-neon px-8 py-3 bg-[#e8722a] text-[#050505] font-bold uppercase tracking-wider text-sm hover:bg-[#f0ede8] transition-all"
          >
            Next Shows
          </a>
          <a
            href="#booking"
            className="btn-neon-outline px-8 py-3 border border-[#f0ede8]/30 text-[#f0ede8] font-bold uppercase tracking-wider text-sm hover:border-[#7b2fbe] hover:text-[#7b2fbe] transition-all"
          >
            Book DUMDUM
          </a>
        </div>
        ...
        <div className="mt-12 flex items-center justify-center gap-6 animate-fade-in">
          <a
            ...
            title="Instagram"
            className="text-[#f0ede8]/40 hover:text-[#e8722a] hover:drop-shadow-[0_0_8px_rgba(232,114,42,0.5)] transition-all"
          >
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
        <div className="w-5 h-8 border-2 border-[#f0ede8]/20 rounded-full flex items-start justify-center p-1">
          <div className="w-1 h-2 bg-[#e8722a] rounded-full animate-bounce shadow-[0_0_6px_rgba(232,114,42,0.6)]" />
        </div>
      </div>
    </section>
  );
