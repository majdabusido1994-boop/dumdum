    ...
    <section className="py-24 px-6 bg-[#111]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Main video reel — uses the actual hero video */}
          <ScrollReveal className="lg:col-span-2 lg:row-span-2">
            <div className="relative aspect-video bg-[#1a1a1a] overflow-hidden group">
              <video
                muted
                loop
                playsInline
              ...
              {/* Play icon */}
              <div className="absolute inset-0 flex items-center justify-center opacity-40 group-hover:opacity-0 transition-opacity">
          ...
          {/* Placeholder reels with poster images */}
